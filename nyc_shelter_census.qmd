...
**Dataset Link:** [DHS Daily Report- NYC Open Data ](https://data.cityofnewyork.us/Social-Services/DHS-Daily-Report/k46n-sa2m/about_data)
...
#### **Seasonal Trends and Public Health/ Seasonality and the code blue effect**
...
**Story:** By using boxplot to look for seasonal patterns, we see that the overall growth trend is so powerful it has largely erased traditional seasonality. While winter months typically see spikes, the medians for every month are now significantly higher the previous years.
